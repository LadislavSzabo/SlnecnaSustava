<?php
    ...
    $entity = new Entity();
    $slides = $entity->getAllSlidesMesiace();
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['update'])) {
            ...
            if ($entity->updateSlideMesiace($id, $title, $content, $fakt1, $fakt2)) {
            ...
            if ($entity->deleteSlideMesiace($id)) {
...
<main>
    ...
    <div class="domovobraz">
      ...
      <div class="content">
      <h1>Admin Page - upraviť údaje v mesiace.php</h1>
</div>
<div class="container">
